...
<div class="app-container">
 ...
 <form  method="post" action="addvinho.php">
   <div class="user-box">
     <select class="select" name="armario">
        <option name="armario" value="" disabled selected>Armario</option> 
        <?php 
...
?>
        ...
        <option name="armario" value="<?php echo $nome_armario[$iol]; ?>" ><?php echo $nome_armario[$iol]; ?></option> 
...
?>
        ...
        <option name="categoria" value="<?php echo $categoria[$iol]; ?>" ><?php echo $categoria[$iol]; ?></option> 
   ...
   <div class="user-box">
     <select class="select" name="casta">
        <option name="casta" value="" disabled selected>Castas</option> 
        <?php 
...
if($res=mysqli_query($conn,$sql)){
    ...
    $casta[$iol] = $reg['nome_casta'];


?>
        
        <option name="casta" value="<?php echo $casta[$iol]; ?>" ><?php echo $casta[$iol]; ?></option> 
   ...
   <div class="user-box">
     <input type="text" id="text" name="vinho" placeholder="Nome">
     <label style="color:white">Nome do vinho</label>
   </div>


   <div class="user-box">
     <input type="text" id="text" name="quinta" placeholder="Quinta do vinho">
     <label style="color:white">Quinta</label>
   </div>

   <div class="user-box">
     <input type="float" id="text" name="preco" placeholder="Preço">
     <label style="color:white">Preço</label>
   </div>
   
   <div class="user-box">
     <input type="number" id="text" name="ano" placeholder="Ano">
     <label style="color:white">Ano do vinho</label>
   </div>
