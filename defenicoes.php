...
<link rel="stylesheet" href="css/defenicoes.css">
      ...
      <div class="chart-container-wrapper big">
        <div class="chart-containerr">
          <div class="chart-container-header">
            <h2>Eliminar adega</h2>
           
          </div>
      
          <form  method="post" action="apagaradega.php">  
        <?php 
...
if($res=mysqli_query($conn,$sql)){
    ...
    $nome_armario[$iol] = $reg['nome_adega'];
    $id[$iol] = $reg['id_adega'];


?>
        
       <h3 style="color:white;"><?php echo $nome_armario[$iol]; ?></h3>
       <td style=" padding-left: 30px;"><?php echo "<a style='background-color:#040f32;border-radius:6px;color:white;' class='cards-button buttonver' href='apagaradega.php?id=" . $reg['id_adega'] . "'>Eliminar</a><br>"; ?></td>
...
if($res=mysqli_query($conn,$sql)){
    ...
    $id[$iol] = $reg['id_armario'];


?>
        
       <h3 style="color:white;"><?php echo $armario[$iol]; ?></h3>
       <td style=" padding-left: 30px;"><?php echo "<a style='background-color:#040f32;border-radius:6px;color:white;' class='cards-button buttonver' href='apagararmario.php?id=" . $reg['id_armario'] . "'>Eliminar</a><br>"; ?></td>
