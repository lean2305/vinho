...
<link rel="stylesheet" href="css/viewvinho.css">
...
<div class="app-container">
 ...
 <form  method="post" action="removevinho.php">
   <div class="user-box">
   <h1 style="color:white;text-align: center;"><?php echo $armario; ?></h1>
     
        <?php 

$sql ="SELECT * FROM vinho WHERE nome_armario = '$armario' ";
...
if($res=mysqli_query($conn,$sql)){
    ...
    $ano[$iol] = $reg['ano'];
    $quinta[$iol] = $reg['quinta'];
    $castas[$iol] = $reg['castas'];
    $preco[$iol] = $reg['preco'];
    $id_vinho[$iol] = $reg['id_vinho'];
      ...
      $result_pg = "SELECT COUNT(id_vinho) AS num_result FROM vinho";
...
<div class="column">
	<div id="00<?php echo $count; ?>" class="listing-header" onclick="togglediv(this)">
		<h3><?php echo $nome_vinho[$iol]; ?></h3>
    
		<!-- <img id="arrow001" src="https://image.flaticon.com/icons/svg/25/25224.svg" class="arrow" /> -->
	</div>
	<div id="body00<?php echo $count; ?>" class="listing">
		<div class="listing-item">
   
<h4 class="vinho" style="color:black;">Categoria: <?php echo $categoria[$iol]; ?></h4>
<h4 class="vinho" style="color:back;">Ano: <?php echo $ano[$iol]; ?></h4>
<h4 class="vinho" style="color:black;">Quinta: <?php echo $quinta[$iol]; ?></h4>
<h4 class="vinho" style="color:black;">Castas: <?php echo $castas[$iol]; ?></h4>
<h4 class="vinho" style="color:black;">Ano: <?php echo $ano[$iol]; ?></h4>
<h4 class="vinho" style="color:black;">Preco: <?php echo $preco[$iol]; ?>€</h4>
<td style=" padding-left: 30px;"><?php echo "<a class='cards-button buttonver' href='removevinho.php?id=" . $reg['id_vinho'] . "'>Eliminar</a><br>"; ?></td>
...
<!-- partial -->
  ...
  <script  src="./viewvinho.js"></script>
</body>
</html>
