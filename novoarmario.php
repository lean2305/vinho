...
<link rel="stylesheet" href="css/novoarmario.css">
...
<div class="app-container">
 ...
 <form  method="post" action="addarmario.php">
   <div class="user-box">
     <select class="select" name="adega">
        <option name="adega" value="" disabled selected>Adega</option> 
        <?php 
...
?>
        ...
        <option name="adega" value="<?php echo $nome_adega[$iol]; ?>" ><?php echo $nome_adega[$iol]; ?></option> 
   ...
   <div class="user-box">
     ...
     <label style="color:white">Nome do novo armario</label>
   </div>
